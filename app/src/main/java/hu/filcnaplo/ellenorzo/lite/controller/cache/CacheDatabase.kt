...
import hu.filcnaplo.ellenorzo.lite.controller.cache.dao.AbsenceListDao
...
@Database(entities = [Evaluation::class, MessageDescriptor::class, Note::class, Absence::class], version = 1)
...
abstract class CacheDatabase : RoomDatabase() {
    ...
    abstract fun absenceListDao(): AbsenceListDao
}
